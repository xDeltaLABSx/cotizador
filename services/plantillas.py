...
PLANTILLAS_BASE = {
    ...
    "Topo - Planimetría (Medio)": {
        "unidad": "m2", "precio_base": 12.50,
    ...
    "Topo - Planimetría (Alto)": {
        "unidad": "m2", "precio_base": 15.00,
    ...
    "Topo - P&A (Planimetría y Altimetría)": {
        "unidad": "m2", "precio_base": 18.00,
    ...
    "Topo - P&A&G (Planimetría, Altimetría y Georeferenciación)": {
        "unidad": "m2", "precio_base": 22.00,
    ...
    "Arq - E&Instalaciones (Estructural e Instalaciones)": {
        "unidad": "m2", "precio_base": 30.00,
    ...
    "GNSS - Linea Base LOCAL": {
        "unidad": "lote", "precio_base": 3500.00,
    ...
    "GNSS - Linea Base Foraneo": {
        "unidad": "lote", "precio_base": 6000.00,
    ...
    "Visita - Local": {
        "unidad": "jornada", "precio_base": 2500.00,
    ...
    "Visita - Foranea": {
        "unidad": "jornada", "precio_base": 4500.00,
    ...
    "Cuadrilla - Local": {
        "unidad": "semana", "precio_base": 18000.00,
    ...
    "Cuadrilla - Foranea": {
        "unidad": "semana", "precio_base": 26000.00,
    ...
    "Fotogrametria - Jornada": {
        "unidad": "jornada", "precio_base": 8000.00,
    ...
    "Vuelo Lidar - Jornada": {
        "unidad": "jornada", "precio_base": 15000.00,
...
def cargar_plantillas_iniciales():
    """Devuelve las plantillas base y las inicializa en sesión si es necesario."""
